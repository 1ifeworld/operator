export const riverAccountAbi = [
  ...
  { inputs: [], name: 'Mismatched_Array_Lengths', type: 'error' },
  { inputs: [], name: 'OnlyAdmin_Or_Entrypoint', type: 'error' },
  { inputs: [], name: 'Only_Admin', type: 'error' },
  {
    anonymous: false,
    inputs: [
      {
